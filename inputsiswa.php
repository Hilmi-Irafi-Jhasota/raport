        ...
        <div class="col-md-9 p-4 overflow-auto" style="height: 100vh;">
            ...
            <div class="card mb-4" id="inputSiswa">
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <button type="submit" name="Tambah_Siswa" class="btn btn-success">Tambah Siswa</button>
                    </form>
                </div>
            </div>
            ...
            <form method="GET" action="" class="mb-3">
                <div class="row g-2">
                    ...
                    <div class="col-md-4">
                        <select name="filter_kelas_siswa" class="form-select">
                            <option value="0">Semua Kelas</option>
                            <?php for($i=1;$i<=6;$i++): ?>
                                <option value="<?= $i ?>" <?= (isset($_GET['filter_kelas_siswa']) && $_GET['filter_kelas_siswa']==$i) ? 'selected' : '' ?>><?= $i ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    <div class="col-md-2">
